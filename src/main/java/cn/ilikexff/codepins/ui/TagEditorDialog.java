...
public class TagEditorDialog extends DialogWrapper {
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        currentTagsPanel.setBorder(JBUI.Borders.empty(5));
        ...
        tagsScrollPane.setPreferredSize(new Dimension(380, 150));
        ...
        currentTagsPanel.add(removeButton, BorderLayout.SOUTH);
        
        // 新标签面板
        JPanel newTagPanel = new JPanel(new BorderLayout());
        newTagPanel.setBorder(JBUI.Borders.empty(5));
        ...
        // 组装主面板
        mainPanel.add(currentTagsPanel, BorderLayout.NORTH);
