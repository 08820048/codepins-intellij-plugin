...
public class ExportDialog extends DialogWrapper {
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        JLabel descLabel = new JLabel("选择要导出的图钉，然后点击'确定'按钮导出到文件。");
        ...
        listPanel.setBorder(JBUI.Borders.empty(10, 0, 0, 0));
        ...
        // 添加选择变化监听器
        exportAllRadio.addActionListener(e -> pinsList.setEnabled(false));
