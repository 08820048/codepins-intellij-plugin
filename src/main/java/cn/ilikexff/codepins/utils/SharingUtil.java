...
public class SharingUtil {
    ...
    public static String formatPin(Project project, PinEntry pin, SharingFormat format, boolean codeOnly) {
        ...
        if (format == SharingFormat.CODE_ONLY || codeOnly) {
            return getCodeSnippet(project, pin);
        }
    ...
    public static String formatPins(Project project, List<PinEntry> pins, SharingFormat format, boolean codeOnly) {
        ...
        switch (format) {
            ...
            case HTML:
                ...
                // 添加水印
                content.append("<div class=\"watermark\">Powered by CodePins</div>\n");
                ...
                content.append("  <p>Generated by <strong>CodePins</strong> - The Modern Code Bookmarking Solution</p>\n");
                content.append("</div>\n");
            ...
            case JSON:
                // 使用现有的JSON导出功能
                // 这里可以调用ImportExportUtil中的相关方法
                content.append("请使用JSON导出功能");
                break;
     ...
     * @return 代码片段
     */
    private static String getCodeSnippet(Project project, PinEntry pin) {
        try {
            Document doc = pin.marker.getDocument();
     ...
     * @return 语言标识
     */
    private static String getFileLanguage(String filePath) {
        try {
